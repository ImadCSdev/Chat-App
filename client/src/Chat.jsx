    ...
    useEffect(() => {
      ...
      function handleMessage(ev) {
        ...
        async function sendMessage(ev, file = null)
         { if (ev) ev.preventDefault(); await ws.send( JSON.stringify({ recipient: selectedUserId, text: newMessageText, file, }) )
         ; if (file) { setTimeout(() => { axios.get("/messages/" + selectedUserId).then((res) => { setMessages(res.data);
         }); },
          500); } 
          else 
          { setNewMessageText(""); 
